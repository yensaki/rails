...
class Module
  ...
  def mattr_accessor(*syms, instance_accessor: true, instance_reader: true, instance_writer: true, &blk)
    mattr_reader(*syms, instance_accessor: instance_accessor, instance_reader: instance_reader, instance_writer: instance_writer, &blk)
    mattr_writer(*syms, instance_accessor: instance_accessor, instance_reader: instance_reader, instance_writer: instance_writer)
  end
